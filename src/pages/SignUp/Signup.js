...
import { HiOutlineInformationCircle, HiCheckCircle, HiXCircle } from "react-icons/hi";
    ...
    <div className="loginpage">
      ...
      <div className="logincont">
        ...
        <div className="loginitem">
          ...
          <input
            className={
              passwordborder ? "inputborderred logininput passwordsignupinput" : "logininput passwordsignupinput"
            }
          ...
          {passwordborder && (
            <div className="passerr" style={{ display: "flex", alignItems: "center" }}>
        ...
        >
          {isLoading ? <ClipLoader color="white" size={23}></ClipLoader> : "Sign Up"}
        </button>
