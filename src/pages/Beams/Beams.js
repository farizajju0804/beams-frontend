...
export const Beams = () => {
  ...
  return (
    <div className="beamspage">
      <GotoTop />
      {notesPopup && <Popupnotes data={notepopupdata} handleClose={closenotePopup}></Popupnotes>}
      {modelopen && (
        <Popup
      ...
      {sharemodelstaus && <ShareModel handleClose={closesharemodel} url={sharemodelurl} />}
      ...
      {/* <FirstHighlightPopUp /> */}
      {firsthightlight && <FirstHighlightPopUp handleClose={() => setFirsthightlight(false)}></FirstHighlightPopUp>}
